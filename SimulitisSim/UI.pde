public class UI{
  ...
  */
  public void display(int citySize){
    ...
    text("Day: " + dayCount, citySize/2-citySize/5, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citSize
    text("Current Infections: " + infected, citySize/2+citySize/5, citySize - 25);
    
    text("Recovered: " + recovered, citySize/2+citySize/5, citySize - 50);
    
    // Replace the number 0 with an expression that contains the variable citSize
    text("Dead: " + dead, citySize/2-citySize/5, citySize - 50);
  }
}
